...
exports.getJournalEntries = exports.getGeneralLedger = exports.getTrialBalance = exports.getAccountBalances = exports.deleteAccount = exports.updateAccount = exports.getAccounts = exports.createAccount = void 0;
...
const createAccount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const account = new Account_1.default({ name, code, type, parent: parentId, description });
        yield account.save();
...
const updateAccount = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const parentId = parent === '' ? undefined : parent;
        const account = yield Account_1.default.findByIdAndUpdate(id, { name, code, type, parent: parentId, description }, { new: true });
        if (!account) {
...
const getJournalEntries = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const sanitized = entries.map(entry => (Object.assign(Object.assign({}, entry.toObject()), { lines: entry.lines.map((line) => (Object.assign(Object.assign({}, line), { account: typeof line.account === 'object' && line.account._id ? line.account._id : line.account }))) })));
        res.json(sanitized);
    }
    catch (error) {
